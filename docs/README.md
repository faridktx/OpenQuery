# OpenQuery Docs Index

## Start Here
- [Developer setup (macOS)](dev-setup.md)
...
- [Docker demo setup](docker-setup.md)
- [Root smoke checklist](smoke.md)

## Architecture and Security
- [Architecture](ARCHITECTURE.md)
- [Security and data boundary](security.md)
- [Threat model](threat-model.md)
- [Power mode guardrails](power-mode.md)
